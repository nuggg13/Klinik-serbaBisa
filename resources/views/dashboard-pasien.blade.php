...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <main class="flex-1 p-10">
        ...
        <div id="default" class="text-gray-700">
            <h1 class="text-2xl font-bold mb-4">Selamat datang, Pasien!</h1>
        ...
        <div id="profil" class="hidden text-gray-700 space-y-4">
            ...
            <div><strong>Email:</strong> pasien@email.com</div>
            <div><strong>Nama:</strong> Nugraha Abi Santana</div>
            <div><strong>Umur:</strong> 19</div>
            <div><strong>Jenis Kelamin:</strong> Laki-laki</div>
            <div><strong>Nomor HP:</strong> 081234567890</div>
            <div><strong>Alamat:</strong> Jalan Sehat No. 1, Jakarta</div>
        </div>
